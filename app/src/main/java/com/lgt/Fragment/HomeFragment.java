...
public class HomeFragment extends Fragment {
    ...
    // recycler list
    RecyclerView rv_home_category,rv_category_one, rv_category_two, rv_category_three,rv_recent_items_products;
    HomeAdapter mHomeAdapter, mHomeAdapterTwo, mHomeAdapterThree,mHomeAdapterFour;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv_recent_items_products = view.findViewById(R.id.rv_recent_items_products);
        // set data
        init();
        // set category
        initCategory();
    ...
    private void initList() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            model_four.image = R.drawable.kitchen;
            mlist_four.add(model_three);
        }
        // set adapter
        ...
        mHomeAdapterFour = new HomeAdapter(getActivity(), mlist_four);
        // set adapter
        ...
        rv_recent_items_products.setAdapter(mHomeAdapterFour);
    }
